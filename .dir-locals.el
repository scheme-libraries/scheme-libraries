     ...
     (eval
	  ...
	  (font-lock-add-keywords
	   ...
	   '(("(\\($library\\)\\>" 1 font-lock-keyword-face)
             ...
             ("(\\(define/who\\|define-enumeration\\|define-condition-name\\|define-record-name\\|define-property\\|define-record-type\\|define-syntax/who\\|define-values\\|define-auxiliary-syntax\\)\\>[ \t]*(*\\(\\sw+\\)?"
              (1 font-lock-keyword-face)
              (2 font-lock-function-name-face nil t))
